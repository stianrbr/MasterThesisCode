...
mesh_size = 1.8 m;  // Mesh size
Mesh_radius = 300 m;  // Radius for free surface mesh
FS_mesh_size = 5 m;  // Mesh size for free surface mesh
...
Mesh_Curve1 = Curve46.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve2 = Curve49.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve3 = Curve51.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve4 = Curve52.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve5 = Curve53.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve6 = Curve54.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve7 = Curve46.copyTranslate(Vector3d(0 m,0 m, -0.75*mesh_size));
Mesh_Curve8 = Curve49.copyTranslate(Vector3d(0 m,0 m, -0.75*mesh_size));
Mesh_Curve9 = Curve51.copyTranslate(Vector3d(0 m,0 m, -0.75*mesh_size));
Mesh_Curve10 = Curve52.copyTranslate(Vector3d(0 m,0 m, -0.75*mesh_size));
Mesh_Curve11 = Curve53.copyTranslate(Vector3d(0 m,0 m, -0.75*mesh_size));
Mesh_Curve12 = Curve54.copyTranslate(Vector3d(0 m,0 m, -0.75*mesh_size));
Mesh_Curve13 = Curve46.copyTranslate(Vector3d(0 m,0 m, -1.5*mesh_size));
Mesh_Curve14 = Curve49.copyTranslate(Vector3d(0 m,0 m, -1.5*mesh_size));
Mesh_Curve15 = Curve51.copyTranslate(Vector3d(0 m,0 m, -1.5*mesh_size));
Mesh_Curve16 = Curve52.copyTranslate(Vector3d(0 m,0 m, -1.5*mesh_size));
Mesh_Curve17 = Curve53.copyTranslate(Vector3d(0 m,0 m, -1.5*mesh_size));
Mesh_Curve18 = Curve54.copyTranslate(Vector3d(0 m,0 m, -1.5*mesh_size));
Mesh_Curve19 = Curve1.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve20 = Curve8.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve21 = Curve9.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve22 = Curve10.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve23 = Curve35.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve24 = Curve15.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve25 = Curve18.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve26 = Curve19.copyTranslate(Vector3d(0 m,0 m, -0.25*mesh_size));
Mesh_Curve27 = Curve42.offset(0.25*mesh_size);
Mesh_Curve28 = Curve41.offset(0.25*mesh_size);
Mesh_Point1 = Point(Curve19.intersect(Mesh_Curve28));
Mesh_Point2 = Point(Curve18.intersect(Mesh_Curve27));
Mesh_Curve29 = Mesh_Curve28.divideAt(Mesh_Curve28.parameter(Mesh_Point1));
Delete(Mesh_Curve28);
Mesh_Curve30 = Mesh_Curve27.divideAt(Mesh_Curve27.parameter(Mesh_Point2));
Delete(Mesh_Curve30);
Mesh_Curve30 = Curve42.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve31 = Curve41.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve32 = CreateLineTwoPoints(Mesh_Curve31.end1, Curve41.end1);
Mesh_Curve33 = CreateLineTwoPoints(Mesh_Curve30.end2, Curve58.end1);
Mesh_Curve34 = Curve30.offset(0.25*mesh_size);
Mesh_Curve35 = Curve60.offset(0.25*mesh_size);
Mesh_Curve36 = Curve62.offset(0.25*mesh_size);
Mesh_Curve37 = Curve30.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve38 = Curve60.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve39 = Curve62.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve40 = CreateLineTwoPoints(Point(49.83688735 m,5.95 m,-13 m), Point(3.435234102 m,5.95 m,-13 m));
Mesh_Curve42 = CreateLineTwoPoints(Point(45.50720415 m,0.3 m,-13 m), Point(45.50720415 m,0.3 m,-13 m));
Mesh_Curve41 = CreateLineTwoPoints(Point(45.50720415 m,0.3 m,-13 m), Point(4.990991885 m,0.3 m,-13 m));
Mesh_Curve43 = Mesh_Curve40.copyRotate(Point13,Vector3d(0, 0, 1),120);
Mesh_Curve44 = Mesh_Curve43.copyMirror(Point18,Vector3d(Math.cos(30*Math.PI/180), Math.sin(30*Math.PI/180), 0));
Mesh_Curve45 = Mesh_Curve40.copyTranslate(Vector3d(0 m,0 m, -h_pontoon));
Mesh_Curve46 = Mesh_Curve43.copyTranslate(Vector3d(0 m,0 m, -h_pontoon));
Mesh_Curve47 = Mesh_Curve44.copyTranslate(Vector3d(0 m,0 m, -h_pontoon));
Mesh_Curve48 = CreateLineTwoPoints(Point11, Curve38.end2);
Mesh_Curve49 = CreateLineTwoPoints(Curve9.end2, Curve29.end1);
Mesh_Curve50 = CreateLineTwoPoints(Point6, Curve29.end1);
Mesh_Curve51 = Mesh_Curve49.divideAt(0.048);
Mesh_Curve52 = Mesh_Curve48.divideAt(0.048);
Mesh_Curve53 = Mesh_Curve50.divideAt(0.048);
Mesh_Curve54 = CreateCircularArcFromThreePoints(Mesh_Curve51.end1, Mesh_Curve50.end2, Mesh_Curve48.end2);
Mesh_Curve55 = CreateLineTwoPoints(Mesh_Curve52.end1, Mesh_Curve46.end1);
Mesh_Curve56 = CreateLineTwoPoints(Mesh_Curve54.end1, Mesh_Curve47.end1);
Mesh_Curve57 = CreateLineTwoPoints(Point2, Curve2.end2);
Mesh_Curve58 = CreateLineTwoPoints(Point3, Curve2.end2);
Mesh_Curve59 = Mesh_Curve57.divideAt(0.048);
Mesh_Curve60 = Mesh_Curve58.divideAt(0.048);
Mesh_Curve61 = Mesh_Curve57.copyRotate(Point1,Vector3d(0, 0, 1),-45);
Mesh_Curve62 = CreateCircularArcFromThreePoints(Mesh_Curve59.end1, Mesh_Curve61.end2, Mesh_Curve60.end1);
Mesh_Curve63 = CreateLineTwoPoints(Mesh_Curve62.end1, Mesh_Curve45.end1);
Mesh_Curve64 = Curve32.copyTranslate(Vector3d(0 m,0 m, 0.25*mesh_size));
Mesh_Curve65 = CreateLineTwoPoints(Mesh_Curve64.end1, Curve32.end1);
Mesh_Curve66 = Curve32.offset(0.25*mesh_size);
Mesh_Point3 = Point(Mesh_Curve66.intersect(Curve15));
Mesh_Curve67 = Mesh_Curve66.divideAt(Mesh_Curve66.parameter(Mesh_Point3));
Delete(Mesh_Curve66);
Mesh_Curve68 = CreateLineTwoPoints(Mesh_Curve30.end2, Mesh_Curve33.end2);
Mesh_FEdge1 = FeatureEdge(Mesh_Curve1);
Mesh_FEdge2 = FeatureEdge(Mesh_Curve2);
Mesh_FEdge3 = FeatureEdge(Mesh_Curve3);
Mesh_FEdge4 = FeatureEdge(Mesh_Curve4);
Mesh_FEdge5 = FeatureEdge(Mesh_Curve5);
Mesh_FEdge6 = FeatureEdge(Mesh_Curve6);
Mesh_FEdge7 = FeatureEdge(Mesh_Curve7);
Mesh_FEdge8 = FeatureEdge(Mesh_Curve8);
Mesh_FEdge9 = FeatureEdge(Mesh_Curve9);
Mesh_FEdge10 = FeatureEdge(Mesh_Curve10);
Mesh_FEdge11 = FeatureEdge(Mesh_Curve11);
Mesh_FEdge12 = FeatureEdge(Mesh_Curve12);
Mesh_FEdge13 = FeatureEdge(Mesh_Curve13);
Mesh_FEdge14 = FeatureEdge(Mesh_Curve14);
Mesh_FEdge15 = FeatureEdge(Mesh_Curve15);
Mesh_FEdge16 = FeatureEdge(Mesh_Curve16);
Mesh_FEdge17 = FeatureEdge(Mesh_Curve17);
Mesh_FEdge18 = FeatureEdge(Mesh_Curve18);
Mesh_FEdge19 = FeatureEdge(Mesh_Curve19);
Mesh_FEdge20 = FeatureEdge(Mesh_Curve20);
Mesh_FEdge21 = FeatureEdge(Mesh_Curve21);
Mesh_FEdge22 = FeatureEdge(Mesh_Curve22);
Mesh_FEdge23 = FeatureEdge(Mesh_Curve23);
Mesh_FEdge24 = FeatureEdge(Mesh_Curve24);
Mesh_FEdge25 = FeatureEdge(Mesh_Curve25);
Mesh_FEdge26 = FeatureEdge(Mesh_Curve26);
Mesh_FEdge27 = FeatureEdge(Mesh_Curve27);
Mesh_FEdge28 = FeatureEdge(Mesh_Curve30);
Mesh_FEdge29 = FeatureEdge(Mesh_Curve29);
Mesh_FEdge30 = FeatureEdge(Mesh_Curve31);
Mesh_FEdge31 = FeatureEdge(Mesh_Curve33);
Mesh_FEdge32 = FeatureEdge(Mesh_Curve36);
Mesh_FEdge33 = FeatureEdge(Mesh_Curve35);
Mesh_FEdge34 = FeatureEdge(Mesh_Curve34);
Mesh_FEdge35 = FeatureEdge(Mesh_Curve37);
Mesh_FEdge36 = FeatureEdge(Mesh_Curve38);
Mesh_FEdge37 = FeatureEdge(Mesh_Curve39);
Mesh_FEdge38 = FeatureEdge(Mesh_Curve40);

Mesh_FEdge40 = FeatureEdge(Mesh_Curve43);
Mesh_FEdge41 = FeatureEdge(Mesh_Curve44);
Mesh_FEdge42 = FeatureEdge(Mesh_Curve45);
Mesh_FEdge43 = FeatureEdge(Mesh_Curve46);
Mesh_FEdge44 = FeatureEdge(Mesh_Curve47);
Mesh_FEdge45 = FeatureEdge(Mesh_Curve54);
Mesh_FEdge46 = FeatureEdge(Mesh_Curve55);
Mesh_FEdge47 = FeatureEdge(Mesh_Curve56);
Mesh_FEdge48 = FeatureEdge(Mesh_Curve62);
Mesh_FEdge49 = FeatureEdge(Mesh_Curve63);
Mesh_FEdge50 = FeatureEdge(Mesh_Curve64);
Mesh_FEdge51 = FeatureEdge(Mesh_Curve65);
Mesh_FEdge52 = FeatureEdge(Mesh_Curve67);
Delete(FEdge1);
Delete(FEdge2);
Delete(FEdge3);
Delete(FEdge5);
...
Delete(FEdge19);
Delete(FEdge20);
Mesh_FEdge53 = FeatureEdge(Point(45.20687384 m,0.3 m,-13 m), Point(45.5 m,5.95 m,-13 m));
Mesh_FEdge54 = FeatureEdge(Point(5.291502622 m,0.3 m,-13 m), Mesh_Curve40.project(Point(5.291502622 m,0.3 m,-13 m)));
Mesh_FEdge55 = FeatureEdge(Point(-2.649999873 m,4.589934713 m,-13 m), Mesh_Curve44.project(Point(-2.649999873 m,4.589934713 m,-13 m)));
Mesh_FEdge56 = FeatureEdge(Point(-2.649999873 m,4.589934713 m,-13 m), Mesh_Curve43.project(Point(-2.649999873 m,4.589934713 m,-13 m)));
Mesh_FEdge57 = FeatureEdge(Point(-22.6 m,39.14434825 m,-13 m), Mesh_Curve43.project(Point(-22.6 m,39.14434825 m,-13 m)));
Mesh_FEdge58 = FeatureEdge(Mesh_Curve27.end1, Mesh_Curve44.project(Mesh_Curve27.end1));


DefaultName(typePoint,"Point",42,"");
DefaultName(typeGuideCurve,"Curve",63,"");
DefaultName(typeFeatureEdge,"FEdge",19,"");
 ...
 */
MyModelTransformerMap = ObjectNameMap();
MyModelTransformerMap.Add(Mesh_FEdge1, "FEdge19");
MyModelTransformerMap.Add(Mesh_FEdge2, "FEdge20");
MyModelTransformerMap.Add(Mesh_FEdge3, "FEdge21");
MyModelTransformerMap.Add(Mesh_FEdge4, "FEdge22");
MyModelTransformerMap.Add(Mesh_FEdge5, "FEdge23");
MyModelTransformerMap.Add(Mesh_FEdge6, "FEdge24");
MyModelTransformerMap.Add(Mesh_FEdge7, "FEdge25");
MyModelTransformerMap.Add(Mesh_FEdge8, "FEdge26");
MyModelTransformerMap.Add(Mesh_FEdge9, "FEdge27");
MyModelTransformerMap.Add(Mesh_FEdge10, "FEdge28");
MyModelTransformerMap.Add(Mesh_FEdge11, "FEdge29");
MyModelTransformerMap.Add(Mesh_FEdge12, "FEdge30");
MyModelTransformerMap.Add(Mesh_FEdge13, "FEdge31");
MyModelTransformerMap.Add(Mesh_FEdge14, "FEdge32");
MyModelTransformerMap.Add(Mesh_FEdge15, "FEdge33");
MyModelTransformerMap.Add(Mesh_FEdge16, "FEdge34");
MyModelTransformerMap.Add(Mesh_FEdge17, "FEdge35");
MyModelTransformerMap.Add(Mesh_FEdge18, "FEdge36");
MyModelTransformerMap.Add(Mesh_FEdge19, "FEdge37");
MyModelTransformerMap.Add(Mesh_FEdge20, "FEdge38");
MyModelTransformerMap.Add(Mesh_FEdge21, "FEdge39");
MyModelTransformerMap.Add(Mesh_FEdge22, "FEdge40");
MyModelTransformerMap.Add(Mesh_FEdge23, "FEdge41");
MyModelTransformerMap.Add(Mesh_FEdge24, "FEdge42");
MyModelTransformerMap.Add(Mesh_FEdge25, "FEdge43");
MyModelTransformerMap.Add(Mesh_FEdge26, "FEdge44");
MyModelTransformerMap.Add(Mesh_FEdge27, "FEdge45");
MyModelTransformerMap.Add(Mesh_FEdge28, "FEdge46");
MyModelTransformerMap.Add(Mesh_FEdge29, "FEdge47");
MyModelTransformerMap.Add(Mesh_FEdge30, "FEdge48");
MyModelTransformerMap.Add(Mesh_FEdge31, "FEdge49");
MyModelTransformerMap.Add(Mesh_FEdge32, "FEdge50");
MyModelTransformerMap.Add(Mesh_FEdge33, "FEdge51");
MyModelTransformerMap.Add(Mesh_FEdge34, "FEdge52");
MyModelTransformerMap.Add(Mesh_FEdge35, "FEdge53");
MyModelTransformerMap.Add(Mesh_FEdge36, "FEdge54");
MyModelTransformerMap.Add(Mesh_FEdge37, "FEdge55");
MyModelTransformerMap.Add(Mesh_FEdge38, "FEdge56");

MyModelTransformerMap.Add(Mesh_FEdge40, "FEdge58");
MyModelTransformerMap.Add(Mesh_FEdge41, "FEdge59");
MyModelTransformerMap.Add(Mesh_FEdge42, "FEdge60");
MyModelTransformerMap.Add(Mesh_FEdge43, "FEdge61");
MyModelTransformerMap.Add(Mesh_FEdge44, "FEdge62");
MyModelTransformerMap.Add(Mesh_FEdge45, "FEdge63");
MyModelTransformerMap.Add(Mesh_FEdge46, "FEdge64");
MyModelTransformerMap.Add(Mesh_FEdge47, "FEdge65");
MyModelTransformerMap.Add(Mesh_FEdge48, "FEdge66");
MyModelTransformerMap.Add(Mesh_FEdge49, "FEdge67");
MyModelTransformerMap.Add(Mesh_FEdge50, "FEdge68");
MyModelTransformerMap.Add(Mesh_FEdge51, "FEdge69");
MyModelTransformerMap.Add(Mesh_FEdge52, "FEdge70");
MyModelTransformerMap.Add(Mesh_FEdge53, "FEdge71");
MyModelTransformerMap.Add(Mesh_FEdge54, "FEdge72");
MyModelTransformerMap.Add(Mesh_FEdge55, "FEdge73");
MyModelTransformerMap.Add(Mesh_FEdge56, "FEdge74");
MyModelTransformerMap.Add(Mesh_FEdge57, "FEdge75");
MyModelTransformerMap.Add(Mesh_FEdge58, "FEdge76");
...
Curve193 = Mesh_Curve1.copyMirror(Point0,Vector3d(0, 1, 0));
Curve194 = Mesh_Curve2.copyMirror(Point0,Vector3d(0, 1, 0));
Curve195 = Mesh_Curve3.copyMirror(Point0,Vector3d(0, 1, 0));
Curve196 = Mesh_Curve4.copyMirror(Point0,Vector3d(0, 1, 0));
Curve197 = Mesh_Curve5.copyMirror(Point0,Vector3d(0, 1, 0));
Curve198 = Mesh_Curve6.copyMirror(Point0,Vector3d(0, 1, 0));
Curve199 = Mesh_Curve7.copyMirror(Point0,Vector3d(0, 1, 0));
Curve200 = Mesh_Curve8.copyMirror(Point0,Vector3d(0, 1, 0));
Curve201 = Mesh_Curve9.copyMirror(Point0,Vector3d(0, 1, 0));
Curve202 = Mesh_Curve10.copyMirror(Point0,Vector3d(0, 1, 0));
Curve203 = Mesh_Curve11.copyMirror(Point0,Vector3d(0, 1, 0));
Curve204 = Mesh_Curve12.copyMirror(Point0,Vector3d(0, 1, 0));
Curve205 = Mesh_Curve13.copyMirror(Point0,Vector3d(0, 1, 0));
Curve206 = Mesh_Curve14.copyMirror(Point0,Vector3d(0, 1, 0));
Curve207 = Mesh_Curve15.copyMirror(Point0,Vector3d(0, 1, 0));
Curve208 = Mesh_Curve16.copyMirror(Point0,Vector3d(0, 1, 0));
Curve209 = Mesh_Curve17.copyMirror(Point0,Vector3d(0, 1, 0));
Curve210 = Mesh_Curve18.copyMirror(Point0,Vector3d(0, 1, 0));
Curve211 = Mesh_Curve19.copyMirror(Point0,Vector3d(0, 1, 0));
Curve212 = Mesh_Curve20.copyMirror(Point0,Vector3d(0, 1, 0));
Curve213 = Mesh_Curve21.copyMirror(Point0,Vector3d(0, 1, 0));
Curve214 = Mesh_Curve22.copyMirror(Point0,Vector3d(0, 1, 0));
Curve215 = Mesh_Curve23.copyMirror(Point0,Vector3d(0, 1, 0));
Curve216 = Mesh_Curve24.copyMirror(Point0,Vector3d(0, 1, 0));
Curve217 = Mesh_Curve25.copyMirror(Point0,Vector3d(0, 1, 0));
Curve218 = Mesh_Curve26.copyMirror(Point0,Vector3d(0, 1, 0));
Curve219 = Mesh_Curve27.copyMirror(Point0,Vector3d(0, 1, 0));
Curve220 = Mesh_Curve30.copyMirror(Point0,Vector3d(0, 1, 0));
Curve221 = Mesh_Curve29.copyMirror(Point0,Vector3d(0, 1, 0));
Curve222 = Mesh_Curve31.copyMirror(Point0,Vector3d(0, 1, 0));
Curve223 = Mesh_Curve32.copyMirror(Point0,Vector3d(0, 1, 0));
Curve224 = Mesh_Curve33.copyMirror(Point0,Vector3d(0, 1, 0));
Curve225 = Mesh_Curve34.copyMirror(Point0,Vector3d(0, 1, 0));
Curve226 = Mesh_Curve35.copyMirror(Point0,Vector3d(0, 1, 0));
Curve227 = Mesh_Curve36.copyMirror(Point0,Vector3d(0, 1, 0));
Curve228 = Mesh_Curve37.copyMirror(Point0,Vector3d(0, 1, 0));
Curve229 = Mesh_Curve38.copyMirror(Point0,Vector3d(0, 1, 0));
Curve230 = Mesh_Curve39.copyMirror(Point0,Vector3d(0, 1, 0));
Curve231 = Mesh_Curve40.copyMirror(Point0,Vector3d(0, 1, 0));
//Curve232 = Mesh_Curve42.copyMirror(Point0,Vector3d(0, 1, 0));
//Curve232 = Mesh_Curve42.copyMirror(Point0,Vector3d(0, 1, 0));
Curve232 = Mesh_Curve41.copyMirror(Point0,Vector3d(0, 1, 0));
Curve233 = Mesh_Curve43.copyMirror(Point0,Vector3d(0, 1, 0));
Curve234 = Mesh_Curve44.copyMirror(Point0,Vector3d(0, 1, 0));
Curve235 = Mesh_Curve45.copyMirror(Point0,Vector3d(0, 1, 0));
Curve236 = Mesh_Curve46.copyMirror(Point0,Vector3d(0, 1, 0));
Curve237 = Mesh_Curve47.copyMirror(Point0,Vector3d(0, 1, 0));
Curve238 = Mesh_Curve48.copyMirror(Point0,Vector3d(0, 1, 0));
Curve239 = Mesh_Curve49.copyMirror(Point0,Vector3d(0, 1, 0));
Curve240 = Mesh_Curve50.copyMirror(Point0,Vector3d(0, 1, 0));
Curve241 = Mesh_Curve51.copyMirror(Point0,Vector3d(0, 1, 0));
Curve242 = Mesh_Curve52.copyMirror(Point0,Vector3d(0, 1, 0));
Curve243 = Mesh_Curve53.copyMirror(Point0,Vector3d(0, 1, 0));
Point84 = Mesh_Point1.copyMirror(Point0,Vector3d(0, 1, 0));
Point85 = Mesh_Point2.copyMirror(Point0,Vector3d(0, 1, 0));
Point86 = Mesh_Point3.copyMirror(Point0,Vector3d(0, 1, 0));
Curve244 = Mesh_Curve54.copyMirror(Point0,Vector3d(0, 1, 0));
Curve245 = Mesh_Curve55.copyMirror(Point0,Vector3d(0, 1, 0));
Curve246 = Mesh_Curve56.copyMirror(Point0,Vector3d(0, 1, 0));
Curve247 = Mesh_Curve57.copyMirror(Point0,Vector3d(0, 1, 0));
Curve248 = Mesh_Curve58.copyMirror(Point0,Vector3d(0, 1, 0));
Curve249 = Mesh_Curve59.copyMirror(Point0,Vector3d(0, 1, 0));
Curve250 = Mesh_Curve60.copyMirror(Point0,Vector3d(0, 1, 0));
Curve251 = Mesh_Curve61.copyMirror(Point0,Vector3d(0, 1, 0));
Curve252 = Mesh_Curve62.copyMirror(Point0,Vector3d(0, 1, 0));
Curve253 = Mesh_Curve63.copyMirror(Point0,Vector3d(0, 1, 0));
Curve254 = Mesh_Curve64.copyMirror(Point0,Vector3d(0, 1, 0));
Curve255 = Mesh_Curve65.copyMirror(Point0,Vector3d(0, 1, 0));
Curve256 = Mesh_Curve68.copyMirror(Point0,Vector3d(0, 1, 0));
Curve257 = Mesh_Curve67.copyMirror(Point0,Vector3d(0, 1, 0));
Curve258 = Curve81.copyMirror(Point0,Vector3d(0, 1, 0));
Curve259 = Curve82.copyMirror(Point0,Vector3d(0, 1, 0));
Curve260 = Curve83.copyMirror(Point0,Vector3d(0, 1, 0));
Curve261 = Curve84.copyMirror(Point0,Vector3d(0, 1, 0));
Curve262 = Curve85.copyMirror(Point0,Vector3d(0, 1, 0));
Curve263 = Curve86.copyMirror(Point0,Vector3d(0, 1, 0));
Curve264 = Curve87.copyMirror(Point0,Vector3d(0, 1, 0));
Curve265 = Curve88.copyMirror(Point0,Vector3d(0, 1, 0));
Curve266 = Curve89.copyMirror(Point0,Vector3d(0, 1, 0));
Curve267 = Curve90.copyMirror(Point0,Vector3d(0, 1, 0));
Curve268 = Curve91.copyMirror(Point0,Vector3d(0, 1, 0));
Curve269 = Curve92.copyMirror(Point0,Vector3d(0, 1, 0));
Curve270 = Curve93.copyMirror(Point0,Vector3d(0, 1, 0));
Curve271 = Curve94.copyMirror(Point0,Vector3d(0, 1, 0));
Curve272 = Curve95.copyMirror(Point0,Vector3d(0, 1, 0));
Curve273 = Curve96.copyMirror(Point0,Vector3d(0, 1, 0));
Curve274 = Curve97.copyMirror(Point0,Vector3d(0, 1, 0));
Curve275 = Curve98.copyMirror(Point0,Vector3d(0, 1, 0));
Curve276 = Curve99.copyMirror(Point0,Vector3d(0, 1, 0));
Curve277 = Curve100.copyMirror(Point0,Vector3d(0, 1, 0));
Curve278 = Curve101.copyMirror(Point0,Vector3d(0, 1, 0));
Curve279 = Curve102.copyMirror(Point0,Vector3d(0, 1, 0));
Curve280 = Curve103.copyMirror(Point0,Vector3d(0, 1, 0));
Curve281 = Curve104.copyMirror(Point0,Vector3d(0, 1, 0));
Curve282 = Curve105.copyMirror(Point0,Vector3d(0, 1, 0));
Curve283 = Curve106.copyMirror(Point0,Vector3d(0, 1, 0));
Curve284 = Curve107.copyMirror(Point0,Vector3d(0, 1, 0));
Curve285 = Curve108.copyMirror(Point0,Vector3d(0, 1, 0));
Curve286 = Curve109.copyMirror(Point0,Vector3d(0, 1, 0));
Curve287 = Curve110.copyMirror(Point0,Vector3d(0, 1, 0));
Curve288 = Curve111.copyMirror(Point0,Vector3d(0, 1, 0));
Curve289 = Curve112.copyMirror(Point0,Vector3d(0, 1, 0));
Curve290 = Curve113.copyMirror(Point0,Vector3d(0, 1, 0));
Curve291 = Curve114.copyMirror(Point0,Vector3d(0, 1, 0));
Curve292 = Curve115.copyMirror(Point0,Vector3d(0, 1, 0));
Curve293 = Curve116.copyMirror(Point0,Vector3d(0, 1, 0));
Curve294 = Curve117.copyMirror(Point0,Vector3d(0, 1, 0));
Curve295 = Curve118.copyMirror(Point0,Vector3d(0, 1, 0));
Curve296 = Curve119.copyMirror(Point0,Vector3d(0, 1, 0));
Curve297 = Curve120.copyMirror(Point0,Vector3d(0, 1, 0));
Curve298 = Curve121.copyMirror(Point0,Vector3d(0, 1, 0));
Curve299 = Curve122.copyMirror(Point0,Vector3d(0, 1, 0));
Curve300 = Curve123.copyMirror(Point0,Vector3d(0, 1, 0));
Curve301 = Curve124.copyMirror(Point0,Vector3d(0, 1, 0));
Curve302 = Curve125.copyMirror(Point0,Vector3d(0, 1, 0));
Curve303 = Curve126.copyMirror(Point0,Vector3d(0, 1, 0));
Curve304 = Curve127.copyMirror(Point0,Vector3d(0, 1, 0));
Curve305 = Curve128.copyMirror(Point0,Vector3d(0, 1, 0));
Curve306 = Curve129.copyMirror(Point0,Vector3d(0, 1, 0));
Curve307 = Curve131.copyMirror(Point0,Vector3d(0, 1, 0));
Curve308 = Curve130.copyMirror(Point0,Vector3d(0, 1, 0));
Curve309 = Curve132.copyMirror(Point0,Vector3d(0, 1, 0));
Curve310 = Curve133.copyMirror(Point0,Vector3d(0, 1, 0));
...
FS_density = MeshDensity(FS_mesh_size);
